...
import { LOGOUT_USER } from './../../config/types'
import Http from './../../config/httpService'
import { removeCookieAndLogout } from './../../helpers/cookies'
const Topnavigation = () => {
                ...
                <li className="ms-nav-item ms-nav-user dropdown">
                    <Dropdown className="custom-dropdown">
                        ...
                        <Dropdown.Menu className="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                            ...
                            <div className="dropdown-menu-footer">
                                <button onClick={logout} style={{ width: '100%' }} className="btn media fs-14 p-2"> <span><i className="flaticon-shut-down mr-2" /> Logout</span>
                                </button>
                            </div>
                        </Dropdown.Menu>
                    </Dropdown>
